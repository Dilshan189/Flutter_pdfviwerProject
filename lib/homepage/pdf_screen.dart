...
class _PDFScreenState extends State<PDFScreen> {
  late PdfControllerPinch pdfControllerPinch;  // Corrected to PdfControllerPinch
  ...
  @override
  void dispose() {
    pdfControllerPinch.dispose(); // Corrected controller disposal
    SystemChrome.setPreferredOrientations([
      DeviceOrientation.portraitUp,
      DeviceOrientation.portraitDown,
    ]);
  ...
  Future<void> loadController() async {
    ...
    setState(() {}); // Rebuild after controller is loaded
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          Container(
            ...
            child: Text(
              pdfControllerPinch.pagesCount == null
                  ? ' '
                  : "Pages: ${pdfControllerPinch.pagesCount}",
      ...
      body: Center(
        child: PdfViewPinch(controller: pdfControllerPinch), // Corrected to PdfViewPinch
      ),
