...
class SpliteSearchbar extends StatefulWidget {
  const SpliteSearchbar({super.key});

  @override
  State<SpliteSearchbar> createState() => _SpliteSearchbarState();
}

class _SpliteSearchbarState extends State<SpliteSearchbar> {
