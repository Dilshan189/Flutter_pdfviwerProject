...
class LockSearbar extends StatefulWidget {
  const LockSearbar({super.key});

  @override
  State<LockSearbar> createState() => _LockSearbarState();
}

class _LockSearbarState extends State<LockSearbar> {
